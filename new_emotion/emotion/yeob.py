...
def print_tensors_in_checkpoint_file(file_name, tensor_name, all_tensors,
  ...
  """
  try:
    #f = open("c:\\Users\\kingjy79\\Documents\\rlawhdduq1\\VSCODE\\fprint_test\\w_trained.dat", 'w')
    ...
    if all_tensors or all_tensor_names:
      ...
      np.savetxt("c:\\Users\\kingjy79\\Documents\\rlawhdduq1\\VSCODE\\data\\w_conv2d2_w_n_resize.dat",shape1.flatten())
      print("pass")
    #f.close()
